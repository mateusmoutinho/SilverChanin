rm -rf release
mkdir release
./silverchain.o --tags api_dependencies  api_const  api_type api_declare api_define cli_dependencies cli_type cli_globals  cli_declare cli_define --src src --project_short_cut  SilverChain
